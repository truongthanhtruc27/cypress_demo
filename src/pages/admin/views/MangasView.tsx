...
const initMangas = [
  { id: 268, title: "Vân Tường Chí Vương", author: "a", desc: "Truyện hay", date: "12/02/2023 12:03:35 am", views: 4, likes: 0, genre: "Du hành", type: "Thường", price: 0, image: "https://picsum.photos/40/56?1" },
  { id: 267, title: "Bậc Thầy Thuần Hóa", author: "Ganika", desc: "Truyện hay", date: "12/02/2023 04:48:39 pm", views: 1, likes: 0, genre: "Kỳ ảo", type: "Thường", price: 0, image: "https://picsum.photos/40/56?2" },
  { id: 266, title: "Hệ Thống Gánh Con Mạnh Nhất", author: "Jakani", desc: "Truyện hot", date: "12/02/2023 04:45:47 pm", views: 7, likes: 0, genre: "Nhiệt huyết", type: "Thường", price: 0, image: "https://picsum.photos/40/56?3" },
  { id: 265, title: "Đại Chu Tiên Lại", author: "LiMaCha", desc: "Truyện viễn tưởng hay", date: "12/02/2023 04:43:42 pm", views: 4, likes: 2, genre: "Du hành", type: "Thường", price: 0, image: "https://picsum.photos/40/56?4" },
  { id: 264, title: "Đại Đường Sóng Thần", author: "Namco", desc: "Truyện hot", date: "12/02/2023 04:41:25 pm", views: 2, likes: 0, genre: "Nhiệt huyết", type: "Hot", price: 0, image: "https://picsum.photos/40/56?5" },
  { id: 263, title: "Siêu Phàm Truyền Thuyết", author: "TKing", desc: "Hay", date: "12/02/2023 04:39:10 pm", views: 9, likes: 1, genre: "Kỳ ảo", type: "Thường", price: 0, image: "https://picsum.photos/40/56?6" },
];

const genres = ["Tất cả", "Nhiệt huyết", "Du hành", "Kỳ ảo", "Lãng mạn", "Bí ẩn", "Đời thường"];
...
const s: Record<string, React.CSSProperties> = {
  ...
  input: { background: "#ffffff", border: "1px solid #d6e0e7", borderRadius: 8, padding: "9px 14px", color: "#16202a", fontSize: 13, outline: "none", flex: 1, minWidth: 180 },
  select: { background: "#ffffff", border: "1px solid #d6e0e7", borderRadius: 8, padding: "9px 12px", color: "#16202a", fontSize: 13, outline: "none", cursor: "pointer" },
  ...
  td: { color: "#66727f", padding: "10px 12px" },
